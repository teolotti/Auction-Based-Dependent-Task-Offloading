...
public class OneTimeLoadGenerator extends LoadGeneratorModel{
	int taskTypeOfDevices[];
	public OneTimeLoadGenerator(int _numberOfMobileDevices, double _simulationTime, String _simScenario) {
	...
	public void initializeModel() {
		...
		for(int i=0; i<numberOfMobileDevices; i++) {
			...
			double activePeriodStartTime = SimSettings.CLIENT_ACTIVITY_START_TIME + interval;  //active period starts shortly after the simulation started (e.g. 10 seconds)
